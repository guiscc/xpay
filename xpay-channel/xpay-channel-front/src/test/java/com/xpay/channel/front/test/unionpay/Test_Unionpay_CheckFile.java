...
public class Test_Unionpay_CheckFile extends BaseTest {
    ...
    public void checkfile() throws Exception {
        ...
        data.put("merId", UnionpayUtilaa.merchantNo);                	         //商户代码，请替换正式商户号测试，如使用的是自助化平台注册的777开头的商户号，该商户号没有权限测文件下载接口的，请使用测试参数里写的文件下载的商户号和日期测。如需777商户号的真实交易的对账文件，请使用自助化平台下载文件。
        ...
        UnionpayUtilaa.process(data,"https://101.231.204.80:9080/");
    }
}
