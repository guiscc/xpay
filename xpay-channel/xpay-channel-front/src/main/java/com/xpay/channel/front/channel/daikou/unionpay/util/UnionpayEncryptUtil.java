package com.xpay.channel.front.channel.daikou.unionpay.util;
...
public class UnionpayEncryptUtil {
     ...
     * @throws Exception
     */
    public static String getCertId(String cerPath) throws Exception{
    ...
    public static void main(String [] args) throws Exception{
        System.err.println(getCertId("/Users/pang/Desktop/works/cert/verify_sign_acp.cer"));
        System.err.println(encryptData("6216261000000000018" , "UTF-8" , "/Users/pang/Desktop/works/cert/verify_sign_acp.cer"));
        System.err.println(encryptPin("6216261000000000018","123456","UTF-8" , "/Users/pang/Desktop/works/cert/verify_sign_acp.cer")) ;
...
//        System.err.println(encryptData(map, "UTF-8" , "6216261000000000018"));
    ...
    //加密卡号
    public static String encryptData(String cardNo , String charset , String cerPath) throws Exception {
        KeyStoreUtil keyStoreUtil = new KeyStoreUtil();
        keyStoreUtil.loadCer(cerPath);
    ...
    //加密参数
    public static String encryptData(Map<String , String> map , String accNo , String charset , String cerPath) throws Exception {
            ...
            if(key.equals("phoneNo") || key.equals("cvn2") || key.equals("expired")){
                ...
                if(key.equals("pin")){
                    if(null == accNo || "".equals(accNo.trim())){
                        ...
                        value = encryptPin(accNo,value,charset , cerPath);
                    }
                }
        ...
        if(!encryptedInfoSb.toString().equals("")){
            ...
            builder.append("encryptedInfo").append("=").append(encryptData(encryptedInfoSb.toString(), charset , cerPath));
        }else{
    ...
    public static String encryptPin(String accNo,String pin ,String charset , String cerPath) throws Exception{
        KeyStoreUtil keyStoreUtil = new KeyStoreUtil();
        keyStoreUtil.loadCer(cerPath);
        PublicKey key = keyStoreUtil.getPublicKey() ;
