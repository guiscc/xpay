 ...
 */
public class SocketChannelHandler<REQ extends BaseReqDTO> extends AbsChannelTongXinHandler<BaseReqDTO> {
    @Override
    public byte[] send(BaseReqDTO req, byte[] reqMsg, ChannelConfig channelConfig)
