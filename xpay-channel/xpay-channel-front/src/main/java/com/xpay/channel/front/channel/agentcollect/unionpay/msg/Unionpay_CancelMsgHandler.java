...
//import com.xpay.channel.front.dto.agentcollect.CancelRepFrontDTO;
...
// * @Date 16/5/23 下午8:10
// */
//public class Unionpay_CancelMsgHandler extends FmkChannelMsgHandlerImpl<CancelReqDTO,CancelRepFrontDTO> {
//    @Override
...
//
//    @Override
//    public CancelReqFrontDTO beforBuildMsg(CancelReqFrontDTO req, ChannelConfig channelConfig) throws BuildMsgException {
//        try {
...
//
//    @Override
//    public CancelRepFrontDTO resolveMsg(CancelReqDTO req, byte[] rtnMsg, ChannelConfig channelConfig) throws ResolveMsgException {
//        CancelRepFrontDTO repDto = new CancelRepFrontDTO() ;
