 ...
 */
public abstract class AbsChannelExecutor<REQ extends BaseReqDTO, REP extends BaseRepDTO> {
    private static final Logger logger = LoggerFactory.getLogger(AbsChannelExecutor.class);
