...
import com.xpay.admin.sysmgr.dao.SysDictItemMapper;
...
public class SysDictItemServiceImpl implements XpaySysDictItemService {
	...
	public String getItemName(String typeCode, String itemCode)
		...
		try {
			...
			throw new XpayAdminException("error.dictitem.query");
		}
	}
	...
	public SysDictItem getSysDictItem(long id) throws XpayAdminException {
		try {
			...
			throw new XpayAdminException("error.dictItem.get");
		}
	}
	...
	public PageList<SysDictItem> queryWithPage(Map<String, Object> params,
			PageBounds pageBounds) throws XpayAdminException {
		try {
