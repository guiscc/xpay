...
public class HttpRequester {
    ...
    private static ConnectionSocketFactory getSSLFactory(HttpCfg httpCfg) throws Exception {
        ...
        ConnectionSocketFactory sslSF = new SSLConnectionSocketFactory(sslContext, SSLConnectionSocketFactory.ALLOW_ALL_HOSTNAME_VERIFIER);
        return sslSF;
    }
...
//        httpReq.setHeadMap(map);
        ...
        httpCfg.setUrl("https://mas.99bill.com:443/cnp/query_txn");
        httpCfg.setPfxPath("/export/safefile/billpay/81231006011017890.jks");
        httpCfg.setPfxPass("vpos123");
